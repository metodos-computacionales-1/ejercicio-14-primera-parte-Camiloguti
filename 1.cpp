...
Implementation of the whole code link
#include <iostream>
#include <cmath>
using namespace std;
...
Note
Here we solved the problem for two variables, however, from time to time we have to deal with problems that involves many variables therefore the implementation by hand can be quite annoying, so here i implemented a code in c++ that can handle N different variables. I hope it can be useful for the future, take a look at it.
